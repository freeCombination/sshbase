package com.hed.sshbase.common.interceptor;
...
import com.hed.sshbase.user.action.LoginAction;
    ...
    public String intercept(ActionInvocation arg0)
        ...
        if (session.getAttribute("currentUserName") == null) {
            ...
            if(StringUtils.isNotBlank(requestType) && requestType.equalsIgnoreCase("XMLHttpRequest")){
                ...
                String str =
                    "<script type=\"text/javascript\">alert('会话已过期，请重新登录！');top.window.location.href='"
                        + url + "';</script>";// 页面接收
                HttpServletResponse response = ServletActionContext.getResponse();
