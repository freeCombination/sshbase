package com.hed.sshbase.resource.service;
...
public interface IResourceService {
     ...
     * @return List<Resource> 资源对象集合
     */
    public List<Resource> getResourceListByRoleAndType(String roleIds,String resType)
    		throws BusinessException;
     ...
     * @date 2014年9月29日
     * @param roleids 角色IDS
     * @param parentCode 父亲资源的编码
     * @return List<ResourceVo> 资源集合
     * @throws BusinessException
     */
    public ResponseVo getResourceListByRoleIds(String roleids,String parentCode)
			throws BusinessException ;
}
