...
import com.hed.sshbase.user.vo.DictionaryVo;
...
public class UserAction extends BaseAction {
     ...
     * @Fields user :
     */
    private com.hed.sshbase.user.entity.User user;
    ...
    public String uploadExcelToBacthImportUser() {
        try {
            ...
            ServletContext servletContext =
                request.getSession().getServletContext();
            String fileUrl =
                FileUtil.upload(uploadAttach, filename, servletContext.getRealPath("/") + "upload/importUser");
            String message =
                userService.importUser(fileUrl);
    ...
    public com.hed.sshbase.user.entity.User getUser() {
        return user;
    }
    
    public void setUser(com.hed.sshbase.user.entity.User user) {
        this.user = user;
    }
