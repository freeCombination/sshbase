...
public class GroupServiceImpl implements IGroupService {
        ...
        try {
            ...
            if (StringUtils.isNotBlank(ids)) {
                ...
                for (String str : arr) {
                    ...
                    idsArr[i] = NumberUtils.toInt(str);
                    i++;
                }
                
                Map<String, Object> param = new HashMap<String, Object>();
                param.put("delIds", idsArr);
                
                StringBuffer gbbuffer = new StringBuffer();
                gbbuffer.append("delete from GroupMember o where o.group.id in (:delIds)");
                baseDao.executeHql(gbbuffer.toString(), param);
                
                StringBuffer buffer = new StringBuffer();
                buffer.append("delete from Group o where o.id in (:delIds)");
                baseDao.executeHql(buffer.toString(), param);
                result = "success";
            }
    ...
    public ListVo<GroupVo> getGroup(Map<String, String> paramMap)
        ...
        if (StringUtils.isNotBlank(groupName)) {
            hql.append(" and o.groupName like :gpname ");
            
            param.put("gpname", "%" + groupName + "%");
        }
        
        // 统计中条数
        totalSize =
            baseDao.queryTotalCount(hql.toString(), param);
    ...
    public Map<String, Object> validateGroupName(Map<String, String> paramMap)
        ...
        if (StringUtils.isNotBlank(groupName)) {
            ...
            StringBuffer hql = new StringBuffer();
            hql.append("from Group o where 1=1 ");
            hql.append(" and o.groupName= :gpname");

            Map<String, Object> param = new HashMap<String, Object>();
            param.put("gpname", groupName);
            
            // 总条数
            totleSize = baseDao.queryTotalCount(hql.toString(), param);
        }
