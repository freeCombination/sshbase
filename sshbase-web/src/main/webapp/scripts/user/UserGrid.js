...
sshframe.user.updateUser = function(userId) {
	...
	basicForm.load({
		...
		/*,success :function(form, action){
			...
			if(sshframe.user.jobStore.find( 'pkDictionaryId', 12222)==-1){
				sshframe.user.jobStore.insert(0,[{"pkDictionaryId": 12222,"dictionaryName": 'dictionaryName'}]);
				basicForm.findField('user.job1.pkDictionaryId').setValue(12222);
				sshframe.user.jobStore.on('load',function(store,recs){
					store.insert(0,[{"pkDictionaryId": 12222,"dictionaryName": 'dictionaryName'}]);
					basicForm.findField('user.job1.pkDictionaryId').setValue(12222);
				});
			}
		}*/
